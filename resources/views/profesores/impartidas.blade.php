            ...
            @foreach($materias as $materia)
                ...
                <article>
                    <tr>
                        ...
                        <td class="">
                            {!! Form::open(['url' => 'profesores/quitar',
                                 'method' => 'POST',
                                 'class' => 'formDelete',
                                  'id' => 'form'.$materia->id]) !!}
                            <div class="ui buttons">
                                ...
                                <button type="submit" class="btn-floating btn-large waves-effect waves-light red btn tooltipped" data-position="right" data-delay="50" data-tooltip="Quitar"><i class="material-icons">delete</i></button>
                            </div>
                            {!! Form::close() !!}
                        </td>
                    </tr>
