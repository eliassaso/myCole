...
<div class="container-fluid panel panel-default">
    ...
    {!! Form::hidden('id_tema', $id_tema, ['class'=>'form-control'])  !!}
    <!-- Body Form Input -->
    ...
    <div class="form-group">
        ...
        {{ Form::select('respuesta', array('1' => 'respuesta_1', '2' => 'respuesta_2','3' => 'respuesta_3','4' => 'respuesta_4',), null, array('class'=>'form-control browser-default'))  }}
    </div>
