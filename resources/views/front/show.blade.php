      ...
      <nav>
        <div class="row">
          <div class="col s12">
            ...
            <a href="{{ url('/front/'.$mat->degree) }}" class="breadcrumb">Grado {!! $mat->degree !!}</a>
            <a href="{{ url('/titulos/'.$mat->id) }}" class="breadcrumb">{!! $mat->nombre_materia !!}</a>
            <a href="{{ url('/finalshow/'.$tema->id) }}" class="breadcrumb">{!! $tema->title !!}</a>
          </div>
        </div>
      </nav>
@endforeach
